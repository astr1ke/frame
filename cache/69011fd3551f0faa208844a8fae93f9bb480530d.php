<?php /* /home/vagrant/code/resources/view/layouts/footer.blade.php */ ?>
                    ...
                    <div class="">
                        <div class="footer-widget-content about-widget">
                            ...
                            <div class="widget-content">
                                ...
                                ?>
                                <p><?php echo e($aboutMeFooter->title); ?></p>
                            </div>
                ...
                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12 footer-block">
                    <div class="footArt">
                        <div class="footer-widget-content">
                            ...
                            $i=1;
                            ?>
                            <?php $__currentLoopData = $popArticlesFooter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $popArticle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($i<=4): ?>
                                    <?php $i++?>
                                        <div class="widget-content">
                                            <div class="widget-posts">
                                                ...
                                                <div class="posted-date">
                                                    <span><a href="/article/<?php echo e($popArticle->id); ?>"><?php echo e(is_object($popArticle->created_at) ? $popArticle->created_at->format('d  F  Y  в  H:i') : ''); ?></a></span>
                                                </div>
                                            </div>
                                        </div>
                                        <br>
