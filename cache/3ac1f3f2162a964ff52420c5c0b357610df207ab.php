<?php /* /home/vagrant/code/view/Article/articleView.blade.php */ ?>
...
<?php $__env->startSection('styles'); ?>
    ...
    <link rel="stylesheet" type="text/css" media="all" href="<?php echo e(asset('modules/comments/css')); ?>/comments.css" />
                                        ...
                                        <div class="comments">
                                            <div class="comments__list">
                                                <div class="comment-listing-tile">
                                                    <h4>Найдено коментариев: <?php echo e($cc); ?></h4>
                                                </div>
                                                <div style="padding-bottom: 320px">
                                                    <?php echo $__env->make('comments.comments_block', ['article' => $articles], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php $__env->startSection('scripts'); ?>
            ...
            <script type="text/javascript" src="<?php echo e(asset('modules/comments/js')); ?>/comment-reply.js"></script>
            <script type="text/javascript" src="<?php echo e(asset('modules/comments/js')); ?>/comment-scripts.js"></script>
<?php $__env->stopSection(); ?>
