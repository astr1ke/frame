<div class="span3" id="sidebar">
    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
        ...
        <li>
            <a href="/admin/articles"><span class="badge badge-success pull-right"><?php echo e(count(\Models\Article::all()) - 2); ?></span> Список статей</a>
        </li>
    </ul>
</div>
<?php /* /home/vagrant/code/resources/view/admin/leftPanel.blade.php */ ?>