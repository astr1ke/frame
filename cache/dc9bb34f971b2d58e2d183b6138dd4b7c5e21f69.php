                        ...
                        <form id="form" class="blocks" action="/articleEdit" method="post" enctype="multipart/form-data">
                            ...
                            <div class="fld">
                                <p>
                                    ...
                                    <input type="text" class="text" name="title" value="<?php echo e($article->title); ?>" />
                                </p>
                                <p>
                                    ...
                                    <select class="sel" name="categorie_id" size="1">\
                                        ...
                                        ?>
                                                <option selected value='<?php echo e($articleCategorie->id); ?>'><?php echo e($articleCategorie->name); ?></option>
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($cat != $articleCategorie): ?>
                            ...
                            <br/>
                            <p class="area">
                                <textarea class="text" name="text" id="text" rows="10" cols="80"><?php echo e($article->text); ?></textarea>
                            </p>
                            <script>
...
<?php /* /home/vagrant/code/resources/view/editor/articleEdit.blade.php */ ?>