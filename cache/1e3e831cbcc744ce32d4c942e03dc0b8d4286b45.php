                                            ...
                                            <div class="swiper-slide">
                                                <?php if(stristr($articleRecent->image,'http')==TRUE): ?>
                                                    <iframe max-width="800" width="100%" height="200"
                                                            src="<?php echo e($articleRecent->image); ?>" frameborder="0"
                                                            gesture="media" allow="encrypted-media"
                                                            allowfullscreen></iframe>
                                                <?php else: ?>
                                                    <img src="<?php echo e($articleRecent->image); ?>" alt="..."
                                                         style="height: 200px">
                                                <?php endif; ?>
                                                <div class="mask"></div>
                                                <div class="slide-content">
                                                    <div class="post-title">
                                                        <h5>
                                                            <a href="/article/<?php echo e($articleRecent->id); ?>"><?php echo e($articleRecent->title); ?></a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="post-thumb">
                                        <?php if(stristr($popArticle->image,'http')==TRUE): ?>
                                            <iframe max-width="800" width="100%" height="85"
                                                    src="<?php echo e($popArticle->image); ?>" frameborder="0" gesture="media"
...
<?php /* /home/vagrant/code/resources/view/layouts/rigthColumn.blade.php */ ?>